            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">修改报销单</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-md-8 offset-2">
                <div class="card">
                    ...
                    <div class="body">
                        <form:form id="expense_claim_add" modelAttribute="info" action="/expense_claim/edit" method="post">
                            <!-- 报销单编号 -->
                            <form:hidden path="expenseClaim.id"/>
                            <div class="row clearfix">
                            ...
                            <c:forEach items="${info.items}" varStatus="sta">
                                <div id="items">
                                    ...
                                    <!-- 报销单编号 -->
                                    <form:hidden path="items[${sta.index}].expenseClaimId"/>
                                    <div class="row clearfix item">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <label for="items[${sta.index}].expenseType"></label>
                                                <form:select path="items[${sta.index}].expenseType" cssClass="custom-select expenseType" items="${items}"/>
                                                <span class="help-block">请选择报销类型</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <label for="items[${sta.index}].amount" class="control-label"></label>
                                                <form:input path="items[${sta.index}].amount" cssClass="form-control amount"/>
                                                <span class="help-block">请填写报销金额</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                            <div class="form-group">
                                                <label for="items[${sta.index}].remark" class="control-label"></label>
                                                <form:input path="items[${sta.index}].remark" cssClass="form-control remark"/>
